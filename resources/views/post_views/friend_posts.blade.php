...
@section('content')
    <div class="album py-5 bg-light">
        <div class="container">
            @isset($posts)
                <center>
                    <h2>{{ $posts[0]->user['first_name'].' '.$posts[0]->user['last_name']
                    }}  الصفحة الشخصية لـــــــــ </h2>
                </center>
            <div class="row">
                @foreach ($posts as $post)
                    <div class="col-md-4">
                        <div class="card mb-4 box-shadow">
                            <img class="card-img-top" src="{{asset('images/post/'.$post['image_path'])}}" alt="Card
                            image cap" style="height: 250px">
                            <div class="card-body" >
