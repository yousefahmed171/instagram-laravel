	...
	$(document).ready(function() {
			...
			$('#search').typeahead({
				...
				templates: {
					...
					return '<div style="font-weight:normal;direction: rtl; text-align: right; width:100%" class="list-group-item"> <a href="{{url('userinfo')}}/'+data.id+'"> <img src="{{asset('images/avatar')}}/'+data.avatar+'" style=" margin-left: 2%; " width="35px" height="35px"/>' + data.first_name+' '+data.last_name + '</a></div></div>'
					}
				}
			});
        });
