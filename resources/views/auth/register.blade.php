...
<div class="container">
    <div class="py-5 text-center">
        <img class="d-block mx-auto mb-4" src="./assets/img/Instagram.png" alt="" style="width:  20%;">
            ...
            <form class="needs-validation" novalidate method="POST" action="{{ route('register') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="form-group">
                            <input id="name" type="text" class="form-control" name="first_name"  placeholder="الاسم الأول"  required autofocus
                                   value="{{ old('first_name') }}">
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="lastName">الاسم الأخير</label>
                        <input type="text" class="form-control" id="الاسم الأخير" placeholder="الاسم الأخير"
                ...
                <div class="mb-3" dir="ltr">
                    ...
                    <div class="input-group ">
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="username" name="name" placeholder="اسم المستخدم"
                               dir="rtl" required value="{{ old('name') }}">
    ...
    <footer class="my-5 pt-5 text-muted text-center text-small">
        <p class="mb-1">&copy; 2019-2020 انستغرام </p>
    </footer>
</div>
